...
const insertButton = (app, outputObject) => {
    ...
    const page = app.workspace.getActiveViewOfType(obsidian.ItemView);
...
const createContentArray = async (app) => {
    const activeView = app.workspace.getActiveViewOfType(obsidian.ItemView);
    if (activeView) {
...
const command = (app, args, buttonStart) => {
    ...
    if (args.type.includes("prepend")) {
        app.workspace.getActiveViewOfType(obsidian.ItemView).editor.setCursor(buttonStart.lineStart, 0);
        app.commands.executeCommandById(command.id);
    }
    if (args.type.includes("append")) {
        app.workspace.getActiveViewOfType(obsidian.ItemView).editor.setCursor(buttonStart.lineEnd + 2, 0);
        app.commands.executeCommandById(command.id);
    }
